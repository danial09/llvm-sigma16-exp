...
public:
    ...
    const UnexpandedMap &getUnexpanded() const {
        return Unexpanded;
    }
...
public:
    ...
    UnwrappedLine line(llvm::StringRef Text) {
    ...
    TokenList lex(llvm::StringRef Text) {
        return uneof(Lex.lex(Text));
    }

    Chunk tokens(llvm::StringRef Text) {
