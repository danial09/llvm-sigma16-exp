...
struct copy_with_mutable_parameter {
  ...
  copy_with_mutable_parameter& operator=(copy_with_mutable_parameter&);
};
...
struct const_move_assign_and_traditional_move_assign {
  const_move_assign_and_traditional_move_assign& operator=(const_move_assign_and_traditional_move_assign&&);
  const_move_assign_and_traditional_move_assign& operator=(const_move_assign_and_traditional_move_assign&&) const;
};

struct volatile_move_assign_and_traditional_move_assign {
  volatile_move_assign_and_traditional_move_assign& operator=(volatile_move_assign_and_traditional_move_assign&&);
...
struct cv_move_assign_and_traditional_move_assign {
  cv_move_assign_and_traditional_move_assign& operator=(cv_move_assign_and_traditional_move_assign&&);
  cv_move_assign_and_traditional_move_assign& operator=(cv_move_assign_and_traditional_move_assign&&) const volatile;
};
...
struct const_move_assign_and_default_ops {
  ...
  const_move_assign_and_default_ops& operator=(const_move_assign_and_default_ops&&) const;
};
...
struct volatile_move_assign_and_default_ops {
  ...
  volatile_move_assign_and_default_ops& operator=(volatile_move_assign_and_default_ops&&) volatile;
};
...
struct cv_move_assign_and_default_ops {
  ...
  cv_move_assign_and_default_ops& operator=(cv_move_assign_and_default_ops&&) const volatile;
};
