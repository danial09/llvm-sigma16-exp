...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr _Iter base() && { return _VSTD::move(__current_); }
...
#  endif // _LIBCPP_NO_EXCEPTIONS
  ...
  iter_swap(const counted_iterator& __x,
    ...
    _LIBCPP_ASSERT(__x.__count_ > 0 && __y.__count_ > 0, "Iterators must not be past end of range.");
