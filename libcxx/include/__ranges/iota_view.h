...
concept __decrementable =
    incrementable<_Iter> && requires(_Iter __i) {
                              { --__i } -> same_as<_Iter&>;
                              { __i-- } -> same_as<_Iter>;
                            };
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr iota_view(type_identity_t<_Start> __value,
  ...
  _LIBCPP_HIDE_FROM_ABI constexpr iota_view(__iterator __first, __iterator __last)
    requires same_as<_Start, _BoundSentinel>
      : iota_view(std::move(__first.__value_), std::move(__last.__value_)) {}

  _LIBCPP_HIDE_FROM_ABI constexpr iota_view(__iterator __first, _BoundSentinel __last)
    requires same_as<_BoundSentinel, unreachable_sentinel_t>
      : iota_view(std::move(__first.__value_), std::move(__last)) {}

  _LIBCPP_HIDE_FROM_ABI constexpr iota_view(__iterator __first, __sentinel __last)
