...
public:
    ...
    constexpr auto operator*() const {
        return ranges::__tuple_transform([](auto& __i) -> decltype(auto) {
            return *__i;
        }, __current_);
    }
    ...
    constexpr __iterator& operator++() {
        ranges::__tuple_for_each([](auto& __i) {
            ++__i;
        }, __current_);
        return *this;
    }
    ...
    requires __zip_all_random_access<_Const, _Views...> {
        ranges::__tuple_for_each([&]<class _Iter>(_Iter& __i) {
    ...
    requires __zip_all_random_access<_Const, _Views...> {
        ...
        [&]<class _Iter>(_Iter& __i) -> decltype(auto) {
