...
RISCVTargetLowering::RISCVTargetLowering(const TargetMachine &TM,
  ...
  setOperationAction(
      ISD::BSWAP, XLenVT,
      (Subtarget.hasStdExtZbb() || Subtarget.hasStdExtZbkb()) ? Legal : Expand);
  ...
  if (NegMul) {
    // clang-format off
        ...
        case RISCVISD::VFMADD_VL:
            Opcode = RISCVISD::VFNMSUB_VL;
            break;
        case RISCVISD::VFNMSUB_VL:
            Opcode = RISCVISD::VFMADD_VL;
            break;
        case RISCVISD::VFNMADD_VL:
            Opcode = RISCVISD::VFMSUB_VL;
            break;
        case RISCVISD::VFMSUB_VL:
            Opcode = RISCVISD::VFNMADD_VL;
            break;
        }
    // clang-format on
  }
    ...
    if (!Subtarget.hasShortForwardBranchOpt() && isNullConstant(RHS) &&
      ...
      auto isOrXorPattern = [&]() {
        if (CCVal == ISD::SETEQ &&
          ...
          Src1 = FalseV.getOperand(0) == TrueV ? FalseV.getOperand(1)
                                               : FalseV.getOperand(0);
          Src2 = TrueV;
        ...
        if (CCVal == ISD::SETNE &&
          ...
          Src1 = TrueV.getOperand(0) == FalseV ? TrueV.getOperand(1)
                                               : TrueV.getOperand(0);
          Src2 = FalseV;
