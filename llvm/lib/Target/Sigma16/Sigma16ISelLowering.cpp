...
void Sigma16TargetLowering::Sigma16CC::handleByValArg(
...
static const MCPhysReg O16IntRegs[] = {Sigma16::R2, Sigma16::R3};
...
void Sigma16TargetLowering::Sigma16CC::analyzeFormalArguments(
...
void Sigma16TargetLowering::copyByValRegs(
