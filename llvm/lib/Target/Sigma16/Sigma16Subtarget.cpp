...
//@1 }
  // Sigma16GenSubtargetInfo will display features by llc -march=sigma16 -mcpu=help
  Sigma16GenSubtargetInfo(TT, CPU, /*TuneCPU*/ CPU, FS),
  TM(_TM), TargetTriple(TT), TSInfo(),
      InstrInfo(
          Sigma16InstrInfo::create(initializeSubtargetDependencies(CPU, FS, TM))),
